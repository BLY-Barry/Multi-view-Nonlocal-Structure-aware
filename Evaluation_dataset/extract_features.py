...
if __name__ == '__main__':
    ...
    parser.add_argument("--subsets", type=str, default='VIS_SAR', help='VIS_IR, VIS_NIR, VIS_SAR')
    parser.add_argument("--num_features", type=int, default=5000, help='Number of features')
    parser.add_argument("--model", type=str, default='E:\Project\Registration\SPEM-DSRN\Pretrained\OSdataset_train50.pth', help='model path')
    ...
    parser.add_argument("--repeatability-thr", type=float, default=0.6)
